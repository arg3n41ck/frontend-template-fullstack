...
.venv-graphify/bin/python .ai/skills/graphify/scripts/build_graph.py --source apps/web/src --source apps/api/src --source packages/contracts/src
```
...
.venv-graphify\Scripts\python.exe .ai/skills/graphify/scripts/build_graph.py --source apps/web/src --source apps/api/src --source packages/contracts/src
```
