...
The obsolete upstream sensor runner was removed. Use the canonical SKILL.md and this project's package scripts/VERIFICATION.md, not provider-specific executable assets. This reference is historical background; its stack/tool mandates do not override the project.
