...
- palette, theme, or registry color changes: run `pnpm --filter @template/web test:theme`; it verifies palette mappings, shadcn aliases, and rejects raw Tailwind colors in registry primitives.
